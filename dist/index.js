...
var stringify = __nccwpck_require__(5467);
var parse = __nccwpck_require__(7054);
var formats = __nccwpck_require__(7326);
...
var utils = __nccwpck_require__(2401);
...
var bodyParser = __nccwpck_require__(750)
var EventEmitter = (__nccwpck_require__(2361).EventEmitter);
...
var qs = __nccwpck_require__(1578);
...
function loadParser (parserName) {
  ...
  switch (parserName) {
    case 'json':
      parser = __nccwpck_require__(6170)
      break
    case 'raw':
      parser = __nccwpck_require__(2223)
      break
    case 'text':
      parser = __nccwpck_require__(178)
      break
    case 'urlencoded':
      parser = __nccwpck_require__(8876)
      break
  }
...
var createError = __nccwpck_require__(5193)
var destroy = __nccwpck_require__(3225)
var getBody = __nccwpck_require__(3310)
var iconv = __nccwpck_require__(9032)
var onFinished = __nccwpck_require__(4694)
var unpipe = __nccwpck_require__(3124)
var zlib = __nccwpck_require__(9796)
...
var createError = __nccwpck_require__(5193)
var debug = __nccwpck_require__(8237)('body-parser:json')
var read = __nccwpck_require__(4157)
var typeis = __nccwpck_require__(1159)
...
var stringify = __nccwpck_require__(3059);
var parse = __nccwpck_require__(5626);
var formats = __nccwpck_require__(9566);
...
var ccavReqHandler = __nccwpck_require__(9593),
  ccavResHandler = __nccwpck_require__(2089);
...
var http = __nccwpck_require__(3685),
  ...
  ccav = __nccwpck_require__(2011),
  qs = __nccwpck_require__(3477);
...
exports.postRes = function (request, response) {
  var ccavEncResponse = "",
    workingKey = process.env.CCAVENUE_WORKING_KEY, //Put in the 32-Bit key shared by CCAvenues.
    accessCode = process.env.CCAVENUE_ACCESS_CODE, //Put in the 32-Bit key shared by CCAvenues.
    ccavPOST = "";
...
exports.encrypt = function (plainText, workingKey) {
  const keyBuffer = Buffer.from(workingKey, "hex");
  if (keyBuffer.length !== 16) {
    throw new Error(
      "Invalid key length. The key should be 128 bits (16 bytes)."
    );
  }
...
(() => {
const path = __nccwpck_require__(1017);
(__nccwpck_require__(2437).config)({ path: path.resolve(__dirname, "../.env") });
const express = __nccwpck_require__(1204);
const cors = __nccwpck_require__(3873);
const bodyParser = __nccwpck_require__(7076);
const router = __nccwpck_require__(1011);
const app = express();

app.use(cors());
app.use(bodyParser.json());
app.use(express.static("public"));
app.set("views", __nccwpck_require__.ab + "public");
app.engine("html", (__nccwpck_require__(8431).renderFile));
